...
export default function Home() {
  return (
    <div className=" text-5xl mt-36 text-center flex flex-col items-center ">
      ...
      <div className="flex-col flex md:flex-row bg-gray-400 mt-10 w-4/5 m-auto rounded-lg p-5">
        ...
        />
        <p className="text-sm w-2/5 m-auto p-2  rounded-2xl shadow-2xl">
      ...
      <div className="flex-col flex md:flex-row bg-gray-400 mt-10 w-4/5 m-auto rounded-lg p-5">
        ...
        <img
          className="w-6/12 m-auto rounded-2xl shadow-2xl p-2"
          src="/assets/zx10r.jpg"
        />
      </div>
    </div>
  );
